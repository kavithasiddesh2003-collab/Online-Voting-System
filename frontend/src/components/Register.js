          ...
          <div className="rg-field">
            ...
            <div className="rg-pass-wrap">
              <input className="rg-input" type={showPass ? 'text' : 'password'}
                placeholder=""
                autoComplete="off" data-form-type="other" value={password} onChange={e => setPassword(e.target.value)} required />
          ...
          <div className="rg-field">
            ...
            <div className="rg-pass-wrap">
              <input className="rg-input" type={showConfirm ? 'text' : 'password'}
                placeholder=""
                autoComplete="off" data-form-type="other" value={confirm} onChange={e => setConfirm(e.target.value)} required />

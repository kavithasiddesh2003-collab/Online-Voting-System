...
function Login({ onLogin }) {
  ...
  const requestOtp = async () => {
    ...
    try {
      ...
      setMsg('OTP sent to your phone. Check terminal if SMS is not configured.');
    } catch (err) {
